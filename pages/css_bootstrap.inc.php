...
if ($func == 'update')
{
  ...
  else
  {
    ...
    $sqlu->setValue('description', 'Custom CSS Bootstrap');
    $sqlu->setValue('configuration', $css);
    if($sqlu->insert())
    {
      echo rex_info($I18N->msg('rex_mobile_css_saved'));
...
<div class="rex-form">
  <h2 class="rex-hl2"><?php echo $I18N->msg('rex_mobile_css_bootstrap_title'); ?></h2>
  ...
  <div class="rex-form-wrapper">
    ...
    <div class="rex-form-row rex-form-element-v1">
      <p class="rex-form-text">
        <label for="css"><?php echo $I18N->msg('rex_mobile_css_bootstrap_text'); ?></label>
...
<div class="rex-addon-output">
  ...
  <h2 class="rex-hl2"><?php echo $I18N->msg('rex_mobile_css_bootstrap_infotitle'); ?></h2>

  <div class="rex-addon-content">
    <p class="rex-tx1">
    <?php echo $I18N->msg('rex_mobile_css_bootstrap_info'); ?>
    </p>
  </div>
