...
if ($func == 'update')
{
  ...
  if ($sql->getRows() > 0)
  {
    ...
    $sqlu->setWhere('id = 2 AND ptype = 1');
    if($sqlu->update())
    {
      echo rex_info($I18N->msg('rex_mobile_css_saved'));
    }
    else
    {
      echo rex_warning($I18N->msg('rex_mobile_css_not_saved'));
    }
  }
  else
  {
    ...
    $sqlu->setValue('description', 'Custom CSS Foundation');
    $sqlu->setValue('configuration', $css);
    if($sqlu->insert())
    {
      echo rex_info($I18N->msg('rex_mobile_css_saved'));
...
<div class="rex-form">
  <h2 class="rex-hl2"><?php echo $I18N->msg('rex_mobile_css_foundation_title'); ?></h2>
  ...
  <div class="rex-form-wrapper">
    ...
    <div class="rex-form-row rex-form-element-v1">
      <p class="rex-form-text">
        <label for="css"><?php echo $I18N->msg('rex_mobile_css_foundation_text'); ?></label>
...
<div class="rex-addon-output">
  ...
  <h2 class="rex-hl2"><?php echo $I18N->msg('rex_mobile_css_foundation_infotitle'); ?></h2>

  <div class="rex-addon-content">
    <p class="rex-tx1">
    <?php echo $I18N->msg('rex_mobile_css_foundation_info'); ?>
    </p>
  </div>
